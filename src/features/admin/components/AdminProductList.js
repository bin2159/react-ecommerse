...
export default function AdminProductList() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    if (e.target.checked) {
      ...
      // newFilter=newFilter[section.id].filter(ele=>ele!==ele.value) but newFilter is a constant
    }
    ...
    <>
      <div className='bg-white'>
        <div className='flex flex-col items-center justify-center'>
          <Link
            to='product-form'
            className='rounded-md bg-green-600 py-1 mt-2 w-1/4 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
          >
            Add Product
          </Link>
        </div>
              ...
              <div key={product.id}>
                ...
                <div className=' flex m-0'>
                  <Link
                    ...
                    className='rounded-md bg-indigo-600 px-3 py-1 w-full text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
                  >
                    Edit Product
                  </Link>
                </div>
